...
def getModel():
    path1 = "./ckpt/save/700_2/multi_se_resnet50_se_resnext101_NO1_e700_2_fa_model_best_DML.pth.tar"
    path2 = "./ckpt/save/700_2/multi_se_resnet50_se_resnext101_NO2_e700_2_fa_model_best_DML.pth.tar"
