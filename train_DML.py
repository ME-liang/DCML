...
from utils import accuracy, AverageMeter, getWorkBook_DML, f1, precision, recall, auc, roc
...
class Trainer(object):
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            dir = "./ckpt/multi_se_resnet50_DML_se_resnext101_e700_2_with_contrastive.xlsx"
            self.mywb.save(dir)
    ...
    def save_checkpoint(self, i, state, is_best):
        ...
        filename = 'multi_se_resnet50_se_resnext101_NO' + str(i + 1) + '_e700_2_fa_ckpt_DML.pth.tar'
        ckpt_path = os.path.join(self.ckpt_dir, filename)
        torch.save(state, ckpt_path)

        if is_best:
            filename = 'multi_se_resnet50_se_resnext101_NO' + str(i + 1) + '_e700_2_fa_model_best_DML.pth.tar'
            shutil.copyfile(
                ckpt_path, os.path.join(self.ckpt_dir, filename)
            )
