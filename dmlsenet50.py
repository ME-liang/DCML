...
path1 = "./ckpt/save/600_aug/multi_se_resnet50_se_resnext101_NO1_e600_aug_fa_model_best_DML.pth.tar"
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.model = se_resnet50(num_classes=2)
...
def main():
    ...
    features = []
    files_list = []
    imgs_path = open("./SARS-Cov-all.txt", encoding='UTF-8').read().splitlines()
    # x = os.walk(data_dir)
    ...
    sio.savemat(features_dir + '/seresnet50_sars' + '.mat', dic)
