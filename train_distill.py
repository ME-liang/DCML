...
class Trainer(object):
 ...
 bmnmnbnmmn;'
    ...
    def __init__(self, config, data_loader):
        ...
        modelpath = './ckpt/se_resnet50-ce0d4300.pth'
        # self.model = getModel()
        # self.model = models.get_vgg16(self.num_classes, self.feature_extract,self.use_pretrained, self.paramseed)
        m,_,__ = loader_model(9,'se_resnet50', modelpath)
        self.model_teacher = m
        self.model = models.get_resnet34(self.num_classes, self.feature_extract,self.use_pretrained, self.paramseed)
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            dir = "/home/cvnlp/multi_resnet50_distill_resnet34_e50_lr001_40X.xlsx"
            self.mywb.save(dir)
    ...
    def save_checkpoint(self, i, state, is_best):
        i = i+50
        filename = 'multi_resnet50_distill_resnet34_e50_lr001_40X_ckpt_'+str(i)+'.pth.tar'
        ckpt_path = os.path.join(self.ckpt_dir, filename)
        torch.save(state, ckpt_path)

        if is_best:
            filename = 'multi_resnet50_distill_resnet34_e50_lr001_40X_model_best.pth.tar'
            shutil.copyfile(
                ckpt_path, os.path.join(self.ckpt_dir, filename)
            )
