...
def getModel():
    path1 = "./ckpt/save/500_aug/multi_se_resnet50_se_resnext101_NO1_e500_aug_fa_model_best_DML.pth.tar"
    path2 = "./ckpt/save/500_aug/multi_se_resnet50_se_resnext101_NO2_e500_aug_fa_model_best_DML.pth.tar"
...
def se_resnetronghe(pretrained=False):
