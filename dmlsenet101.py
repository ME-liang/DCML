...
path4 = "./ckpt/save/aug/aug_multi_se5_NO4_e400_fa_model_best_DML_1_lr001_newdataALL.pth.tar"
...
seres101, e_, f_ = loader_model1(9, "se_resnet101", path4)
# seresxt50, g_, h_ = loader_model(9, "se_resnext50", path5)
from senet.newse101 import se_resnet101
class Net(nn.Module):
    def __init__(self):
        super(Net, self).__init__()
        self.model = se_resnet101(pretrained=None,num_classes=9)
...
def main():
    ...
    dic = {'seresnet1012n': features}
    sio.savemat(features_dir + '/seresnet1012n' + '.mat', dic)
