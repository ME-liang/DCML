...
from utils import accuracy, AverageMeter, loader_model, loader_model1, load_GPUS
from torch.autograd import Variable
import torch.nn as nn
import torch.nn.functional as F
...
path3 = "./ckpt/save/aug/aug_multi_se5_NO3_e400_fa_model_best_DML_1_lr001_newdataALL.pth.tar"
...
seres152, c_, d_ = loader_model1(9, "se_resnet152", path3)
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.model = se_resnet152(pretrained=None,num_classes=9)
...
features = []
files_list = []
imgs_path = open("./new1.txt").read().splitlines()
# x = os.walk(data_dir)
...
dic = {'seresnet1522n': features}
sio.savemat(features_dir + '/seresnet1522n' + '.mat', dic)
